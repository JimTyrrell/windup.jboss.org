...
# team email subject
EMAIL_SUBJECT="Windup site released at \${PRODUCTION_URL}"
# EAP team email To ?
EMAIL_TO="windup-dev@lists.jboss.org"
EMAIL_FROM="\"Windup Publish Script\" <bdavis@redhat.com>"
...
notify_email()
{
   echo "***** Performing Windup site release notifications"
   echo "*** Notifying Windup dev list"
...
This script publishes the Windup site, either to staging or to production
